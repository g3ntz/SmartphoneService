<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="Smartphone_Service.Index" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Smartphone Service - Create</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:TextBox ID="txtSurname" runat="server" CssClass="auto-style5"></asp:TextBox>
        <br />
            <asp:Label ID="lblPhoneNr" runat="server" ForeColor="White" Text="Phone Nr"></asp:Label>
        <br />
        <asp:TextBox ID="txtPhoneNr" runat="server" CssClass="auto-style4"></asp:TextBox>
        <br />
        <asp:Label ID="lblSelectPhone" runat="server" ForeColor="White" Text="Select Phone"></asp:Label>
        <br />
        <asp:DropDownList ID="DropDownListPhone" runat="server" CssClass="auto-style6">
        ...
        <br />
        <asp:Label ID="lblSelectServiceType" runat="server" ForeColor="White" Text="Select Service Type"></asp:Label>
        <br />
        <asp:DropDownList ID="DropDownListServiceType" runat="server" CssClass="auto-style7">
